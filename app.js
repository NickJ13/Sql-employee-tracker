  ...
  inquirer.prompt([
    {
      ...
      name: "main",
      choices: [
        { name: "View All Employees", value: "VIEW_EMPS" },
        { name: "View Managers", value: "VIEW_MNGRS" },
        { name: "Add Employee", value: "ADD_EMP" },
        { name: "Update Employee Role", value: "UPDATE_ROLE" },
        { name: "Update Employee Manager", value: "UPDATE_MNGR" },
        ...
        { name: "Delete Department", value: "DELETE_DEPT" },
